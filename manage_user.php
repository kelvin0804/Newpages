      ...
      <div class="span12">
	   ...
	   <summary id="summary-style">
        ...
        <tr  >
            ...
            <td><?php echo $row['sales_branch'];?></td>	
            <td><?php echo $row['sales_status'];?></td>			   
			<td><a href="view_salesperson.php?sid=<?php echo $row['Sales_id']; ?>" target="_blank"><img src="image/view.png" height="20px" width="20px" border="0" /></a></td>
