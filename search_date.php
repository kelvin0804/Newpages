...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Search by date</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopaddings">
           ...
           <?php
			...
			if($_SESSION['position']  == 'super')
			{
			  $sql = "SELECT * FROM job WHERE date_submission  >= '$start_date' AND date_submission <= '$end_date' ";
			}
			else if($_SESSION['position']  == 'KL')
			{
			  $sql="SELECT * FROM job  where date_submission  >= '$start_date' AND date_submission <= '$end_date' AND branch_name = 'KL'";
			}
			else if($_SESSION['position']  == 'Johor')
			{
			  $sql="SELECT * FROM job  where date_submission  >= '$start_date' AND date_submission <= '$end_date' AND branch_name = 'Johor'";
			}
			else if($_SESSION['position']  == 'Penang')
			{
			  $sql="SELECT * FROM job  where date_submission  >= '$start_date' AND date_submission <= '$end_date' AND branch_name = 'Penang'";
			}
			else if($_SESSION['position']  == 'Melaka')
			{
			  $sql="SELECT * FROM job  where date_submission  >= '$start_date' AND date_submission <= '$end_date' AND branch_name = 'Melaka'";
			}
			else if($_SESSION['position']  == 'Klang')
			{
	          $sql="SELECT * FROM job  where date_submission  >= '$start_date' AND date_submission <= '$end_date' AND branch_name = 'Klang'";		  
			}
