...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    <?php
	  ...
	  {
	    echo'<li class="active"><a href="home.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>';
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Admin details</a> </div>
    <h1>Admin details</h1>
  </div>
      ...
      <div class="span12">
	   ...
	   <summary id="summary-style">
        ...
        <tr  >
			...
			<td><a href="view_admin.php?aid=<?php echo $row['admin_id']; ?>" target="_blank"><img src="image/view.png" height="20px" width="20px" border="0" /></a></td>
