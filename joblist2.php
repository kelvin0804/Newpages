      ...
      <div class="span12">
        ...
        <div class="widget-box">
         ...
         <?php
			...
			{
			  $query="SELECT * FROM job  where branch_name = 'KL'";
			}
			else if($_SESSION['position']  == 'Johor')
			{
			  $query="SELECT * FROM job  where branch_name = 'Johor'";
			}
			else if($_SESSION['position']  == 'Penang')
			{
			  $query="SELECT * FROM job  where branch_name = 'Penang'";
			}
			else if($_SESSION['position']  == 'Melaka')
			{
			  $query="SELECT * FROM job  where branch_name = 'Melaka'";
			}
			else if($_SESSION['position']  == 'Klang')
			{
	          $query="SELECT * FROM job  where branch_name = 'Klang'";		  
			}
        ...
        <tr  >
            ...
            <td><a href="update_payment_admin.php?jid=<?php echo $row['job_id']; ?>" ><img src="image/view.png" height="20px" width="20px" border="0" /></a></td>
