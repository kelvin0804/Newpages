...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="job.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Job history</a> </div>
    <h1>Job history</h1>
  </div>
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      <div class="span12">
       ...
       <table  data-order='[[ 0, "desc" ]]'id="example" class="table table-bordered data-table"  border="1" >
	        
       <thead>
    	<tr class="h">
        	 <th style="display:none;">Job id</th>
            <th scope="col" class="rounded-company">Job date</th>
			<th scope="col" class="rounded-company">Comapany name</th>
       ...
       <tbody>
        ...
        <tr class="<?php if($x!==0&&$x%10===0){$y=$y+1;echo $y;}else{echo $y;} ?>" >
			...
			<td><a href="update_job.php?jid=<?php echo $row['job_id']; ?>" ><img src="image/update.jpg" height="20px" width="25px" border="0" /></a></td>
			<td><a href="update_payment.php?jid=<?php echo $row['job_id']; ?>" ><img src="image/update.jpg" height="20px" width="25px" border="0" /></a></td>
