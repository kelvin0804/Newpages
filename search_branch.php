...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
   ...
   <li><a href="home.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li class="active"><a href="joblist.php"><i class="icon icon-th"></i> <span>All Job</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Search by Branch</a> </div>
      ...
      <div class="widget-content">
        <div class="control-group">
          <form method="post" action="search_date.php">
		   ...
		   <form  method="post" action="search_branch.php">
	         <p class="search_input">
             ...
             <select name="branch">
              ...
              <option value="KL">KL
			  <option value="Klang">Klang
			  
             </select>	

         				 
		     <input type="submit" class="btn-class"name="search_branch" value="Search" >
	         </p>
           </form >
        </div>
      </div>
           ...
           <?php
			if(!empty($_REQUEST['branch'])  ){
			  $branch=$_POST['branch'];
			    ...
			    $sql = "SELECT * FROM job WHERE branch_name='$branch'";
