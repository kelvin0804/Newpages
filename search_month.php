...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Search by Month</a> </div>
      ...
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopaddings">
           ...
           <?php
			  if(!empty($_REQUEST['month']) || !empty($_REQUEST['year'])   || !empty($_REQUEST['salesperson'])){
			  $month=$_POST['month'];
			  $year=$_POST['year'];
			  $salesperson=$_POST['salesperson'];
			  
			   $sql = "SELECT * FROM job WHERE Month(date_submission)='$month' AND YEAR(date_submission)='$year' AND sales_name='$salesperson'";
