...
session_start();
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = mysqli_real_escape_string($db,$_POST['admin_name']);
      $mypassword = mysqli_real_escape_string($db,$_POST['password']); 
      
      $sql = "SELECT admin_id FROM admin WHERE admin_name = '$myusername' and admin_password = '$mypassword'";
	...
	<div class="row">
	    ...
	    <div class="form-style">
		    <form action="" method="post">
			   ...
			   <p><input id="textbox-style"type="text" name="admin_name" value="Admin username" onBlur="if(this.value == '') this.value = 'Admin username'" onFocus="if(this.value == 'Admin username') this.value = ''" required></p> 
