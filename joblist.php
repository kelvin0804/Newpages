...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
	...
	<li ><a href="view_update2.php"><i class="icon icon-th"></i> <span>Payment Updated </span></a></li>
      ...
      <div class="widget-content">
        <div class="control-group">
          <form method="post" action="search_date.php">
             ...
             <?php
		        $sql=mysqli_query($db,"SELECT * FROM salesperson");
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopaddings">
		   <div style="overflow-x:auto;">
              <table   data-order='[[ 0, "desc" ]]'id="example" class="table table-bordered data-table" >
              <thead>
                <tr>
         ...
         <?php
			$query="SELECT * FROM job where branch_name = 'KL' order by  job_id desc";
