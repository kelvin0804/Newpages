...
<?php
	...
	if(isset($_POST["submit"])){
		...
		mysqli_query($db,"insert into job(date_submission,contract_no,company_name,company_reg_no,gst_no,
					   ...
					   ('$submit_date','$contract_no','$Company_Name','$CompanyReg','$GSTNo','$Company_Address','$Office_Phone','$Office_Fax',
					    '$package','$Advfee','" . $items . "','$Total','$Payment','$amount','$PaymentGst','$PaymentBeforeGST',
						'$payment_date','$customer','$customer_design','$customerPhone','$email_master','$email_billing',
						'$Finalfcard','$FinalFilename','$Finalquotation','$Finalbcard','$FinalSSM','$Finalcheque','$Finalcash','$Finalslip','$Remark',
						'$CompanyName',' $Company_Reg','$GST_No',' $CompanyAddress','$CompanyBusiness',' $OfficePhone','$OfficeFax',
						'$email_website','$DomainType','$DomainName','$CustomerDescription','$Reason','$NoEmailAccount','$Gst','$BeforeGST',
						'$status','$name','$branch_name','$sales_email','$Sales_id')");
		 ...
		 if($amount == ''){
		    ...
		    $subject = "[$branch_name]New Sales and Payment - ". $_POST['Company_Name']. " ";    
		  }
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-box">
		 ...
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error1; ?></div>
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error2; ?></div>
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error3; ?></div>
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error4; ?></div>
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error5; ?></div>
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error6; ?></div>
		 <div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error7; ?></div>
			...
			<b>Total package amount:</b> <?php echo $_POST["Total"]; ?><br/>
